                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('usia') is-invalid @enderror" id="usia" name="usia" value="{{ old('usia') }}" min="0" required>
                                    @error('usia')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('rt') is-invalid @enderror" id="rt" name="rt" required>
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <option value="{{ $i }}" {{ old('rt') == $i ? 'selected' : '' }}>RT {{ $i }}</option>
                                        @endfor
                                    </select>
                                    @error('rt')
                                        <span class="invalid-feedback">{{ $message }}</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('tanggungan') is-invalid @enderror" id="tanggungan" name="tanggungan" value="{{ old('tanggungan') }}" min="1" required>
                                    @error('tanggungan')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('penghasilan') is-invalid @enderror" id="penghasilan" name="penghasilan" value="{{ old('penghasilan') }}" min="0" required>
                                    </div>
                                    @error('penghasilan')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
