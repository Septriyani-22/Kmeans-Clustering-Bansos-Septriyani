...
<div style="background:#fff; border-radius:12px; box-shadow:0 2px 12px rgba(0,0,0,0.07); padding:32px 40px; max-width:900px; margin:0 auto;">
    ...
    <form action="{{ route('admin.users.store') }}" method="POST">
        ...
        <a href="{{ route('admin.users.index') }}" style="background:#888fa6; color:#fff; border:none; border-radius:6px; padding:10px 18px; font-size:1rem; text-decoration:none; margin-left:10px; display:inline-block;">Batal</a>
    </form>
</div>
@endsection